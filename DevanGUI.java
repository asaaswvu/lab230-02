...
class DeanGUI extends JFrame implements ActionListener{
	...
	JButton btnDP = new JButton("My Button");
	...
	btnDP.setActionCommand("my button");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            case "sample":
                ...
                break;
	    case "my button" :
		JOptionPane.showMessageDialog(this,"Sample message dialog box"," plain message",JOptionPane.PLAIN_MESSAGE);
		break;
            case "quit" :
                System.exit(0);
                break;
