...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnMyName = new JButton("Show my name");
	...
	btnMyName.setActionCommand("myName");
	btnMyName.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "myName" :
	 	JOptionPane.showMessageDialog(this,"Dale Campbell","My name is:",JOptionPane.PLAIN_MESSAGE);
		break;     
        }
    }
