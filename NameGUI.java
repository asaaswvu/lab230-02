...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnNameJcase = new JButton("Display Name Case");
        ...
        btnNameJcase.setActionCommand("jcase");  
        btnNameJcase.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "jcase":
                JOptionPane.showMessageDialog(this,"Jeremy Case","This is my name.",JOptionPane.PLAIN_MESSAGE);
                break;
