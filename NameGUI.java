...
class NameGUI extends JFrame implements ActionListener{
    ...
    NameGUI(){
        ...
        JButton btnSchlies = new JButton("Schlies");
	...
	btnSchlies.setActionCommand("schlies");  
        btnSchlies.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            case "sample":
                ...
                break;
	    case "schlies":
                JOptionPane.showMessageDialog(this,"This is a message from Mark Schlies","Hello World!",JOptionPane.PLAIN_MESSAGE);
                break;
            case "quit" :
                System.exit(0);
                break;
